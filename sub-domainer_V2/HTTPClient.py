...
if __name__ == "__main__":
    ...
    print(f"Content: {content[:200]}...")  # Print only the first 200 characters of the content
    if cert:
        print(f"Certificate: {cert[:100]}...")  # Print only the first 100 bytes of the certificate
